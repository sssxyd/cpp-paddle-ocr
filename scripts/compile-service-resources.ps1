...
# Server resource compilation script

Write-Host "=== Compiling Server Resources ===" -ForegroundColor Green
...
# Define file paths
$outputRes = Join-Path $WorkspaceFolder "dist\service_icon.res"
$resourcesDir = Join-Path $WorkspaceFolder "resources"
$inputRc = Join-Path $WorkspaceFolder "resources\service_icon.rc"
